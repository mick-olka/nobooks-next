	...
	return (
		<footer className="footer bg-base-300 p-10 text-base-content">
			<div>
				...
				<Link className="link-hover link" href="https://discord.gg/WrzV6BvEQD">
					Discord
				</Link>
				<Link className="link-hover link" href="https://t.me/noboobs_ua">
					Telegram
				</Link>
				<Link
			...
			<div>
				...
				<div className="grid grid-flow-col gap-4">
					<Link href="https://t.me/noboobs_ua" target="_blank" rel="noreferrer">
						<TelegramIcon />
					</Link>
					<Link
